...
public interface IComboService {
	 ...
	 * @throws Exception
	 */
	boolean updateCombo(Combo combo, MultipartFile file,MultipartFile file2, String staticsPath) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean saveCombo(Combo combo, MultipartFile file,MultipartFile file2, String staticsPath) throws Exception;
