...
public interface ITableReserveService {
	 ...
	 * @return
	 */
	List<TableReserve> listTableReserve(Integer currentPageNo, Integer pageSize,TableReserve tablereserve);
	 ...
	 * @return
	 */
	Integer countTableReserve(TableReserve tablereserve);
}
