...
public class HttpRequest {
	...
	private void setRequestMethod(){
		try {
			...
			BusinessUtils.throwNewBusinessException("设置RequestMethod参数失败" + e.getMessage());
		}
	}
	...
	private void connect(){
		try {
			...
			BusinessUtils.throwNewBusinessException("connect连接失败" + e.getMessage());
		}
	}
	...
	public HttpRequest(URL url){
		...
		try {
			...
			BusinessUtils.throwNewBusinessException("openConnection 出现异常" + e.getMessage());
		}
	}
	/**
	...
	public HttpRequest(String urlStr){
		...
		try {
			...
			BusinessUtils.throwNewBusinessException("url 不合法" + e.getMessage());
		} catch (IOException e) {
			BusinessUtils.throwNewBusinessException("openConnection 出现异常" + e.getMessage());
		}
	}
